...
//                init("stock.trade_url", "stock.trade_port");
    ...
    public static void init() {
        String yd = PropertiesUtil.getConfig("SipChinaMobile");
        String lt = PropertiesUtil.getConfig("SipChinaUnicom");
        String dx = PropertiesUtil.getConfig("SipChinaTelecom");
        ...
        for (int i = 0; i < ipArry.length; i++) {
            ...
            client.registerServer("zt", ipPort[1], Integer.parseInt(ipPort[2]));
