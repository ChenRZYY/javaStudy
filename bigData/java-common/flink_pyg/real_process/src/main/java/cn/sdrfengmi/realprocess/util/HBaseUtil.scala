package cn.sdrfengmi.realprocess.util

import org.apache.hadoop.conf.Configuration
import org.apache.hadoop.hbase.{HBaseConfiguration, TableName}
import org.apache.hadoop.hbase.client.{Admin, ColumnFamilyDescriptor, ColumnFamilyDescriptorBuilder, Connection, ConnectionFactory, Delete, Get, Put, Result, Table, TableDescriptorBuilder}
import org.apache.hadoop.hbase.util.Bytes

/**
  * @Author 陈振东
  * @create 2020/3/30 10:35
  *         HBase的工具类
  *
  *         获取Table
  *         保存单列数据
