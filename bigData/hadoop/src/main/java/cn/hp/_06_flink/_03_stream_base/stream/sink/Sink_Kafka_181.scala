package cn.hp._06_flink._03_stream_base.stream.sink

import java.util.Properties

import cn.hp._06_flink._03_stream_base.stream.datasource.DataSource_MySql_181.MySql_Source_181
...
import org.apache.flink.streaming.util.serialization.KeyedSerializationSchemaWrapper //1.7.2
import org.apache.kafka.clients.producer.ProducerConfig

object Sink_Kafka_181 {
  ...
  def main(args: Array[String]): Unit = {
    ...
    props.put(ProducerConfig.PARTITIONER_CLASS_CONFIG, classOf[CustomPartition])
