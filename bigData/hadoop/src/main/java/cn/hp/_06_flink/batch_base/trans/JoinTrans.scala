...
object JoinTrans {
  ...
  def main(args: Array[String]): Unit = {
    ...
    // readCsvFile
    val scoreDataSet: DataSet[Score] = env.readCsvFile[Score]("D:\\flink_project\\flink-base-project\\flink-batch-base\\src\\main\\resources\\score.csv")
    val subjectDataSet: DataSet[Subject] = env.readCsvFile[Subject]("D:\\flink_project\\flink-base-project\\flink-batch-base\\src\\main\\resources\\subject.csv")
