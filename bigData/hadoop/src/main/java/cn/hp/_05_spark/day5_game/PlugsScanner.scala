/*
package com.hello._05_spark.day5_game

import kafka.serializer.StringDecoder
import org.apache.commons.lang3.time.FastDateFormat
import org.apache.log4j.{Level, Logger}
import org.apache._05_spark.rdd.RDD
import org.apache._05_spark.streaming.kafka.KafkaManager
import org.apache._05_spark.streaming.{Milliseconds, StreamingContext}
import org.apache._05_spark.{SparkConf, SparkContext}
...
object PlugsScanner {
  ...
  def main(args: Array[String]) {
    ...
    conf.set("_05_spark.streaming.kafka.maxRatePerPartition", "100")
    conf.set("_05_spark.serializer", "org.apache._05_spark.serializer.KryoSerializer")
